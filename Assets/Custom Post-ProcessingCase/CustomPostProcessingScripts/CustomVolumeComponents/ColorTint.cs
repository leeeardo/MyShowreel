...
[Serializable,VolumeComponentMenu("CustomsPostProcessing/ColorTint")]
public class ColorTint : CustomVolumeComponent
{
    //parameter
    ...
    //
    public const string ShaderName = "Custom/Postprocess/ColorTint";
