...
Shader "Polyart/Dreamscape Foliage"
{
	...
	SubShader
	{
		...
		half4 DepthNormalsFragment(Varyings input) : SV_TARGET
		{
		    ...
		    float2 uv_FoliageTexture = input.uv.xy * _FoliageTexture_ST.xy + _FoliageTexture_ST.zw;
				float4 tex2DNode10 = SAMPLE_TEXTURE2D( _FoliageTexture,sampler_FoliageTexture, uv_FoliageTexture );
